...
/* harmony import */ var _src_env__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../src/env */ "./src/env.ts");

var ServerConfig = {
    mapApiKey: _src_env__WEBPACK_IMPORTED_MODULE_0__["ENV"].MAP_API_KEY,
    endPoint: _src_env__WEBPACK_IMPORTED_MODULE_0__["ENV"].endPoint
};
...
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-row>\n        <button ion-button class=\"back-button\" [routerLink]=\"['/home']\" >\n          <ion-icon name=\"arrow-round-back\" class=\"back-arrow-icon\"></ion-icon>\n        </button>\n        <ion-title>map</ion-title>\n    </ion-row>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content padding>\n  <div id=\"map_canvas\">\n    <!-- <button ion-button (click)=\"onButtonClick($event)\" class=\"goToLocation\">Start demo</button> -->\n  </div>\n</ion-content>\n"
...
module.exports = "#map_canvas {\n  height: 95%; }\n\n.goToLocation {\n  background: #0000FF;\n  height: 3em; }\n\n.back-button {\n  background: transparent !important; }\n\n.back-arrow-icon {\n  color: black;\n  font-size: 1.3rem; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _config_server__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../config/server */ "./config/server.ts");
...
/* harmony import */ var src_services_device_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/services/device.service */ "./src/services/device.service.ts");
...
var MapPage = /** @class */ (function () {
    function MapPage(platform, toastController, deviceService, navCtrl) {
        this.platform = platform;
        this.toastController = toastController;
        this.deviceService = deviceService;
        this.navCtrl = navCtrl;
        this.mapReady = false;
        this.mapApi = _config_server__WEBPACK_IMPORTED_MODULE_3__["ServerConfig"].mapApiKey;
        this.api = _config_server__WEBPACK_IMPORTED_MODULE_3__["ServerConfig"].endPoint;
        this.curPos = { latitude: null, longitude: null };
        this.curLocation = { lat: null, lng: null };
        this.curMarker = null;
        this.curLocationMarker = null;
        this.oldMarker = null;
        this.oldLocationMarker = null;
    }
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        this.curInterval = setInterval(function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                            var _this = this;
                            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, this.getCurrentLocation().then(function () {
                                            _this.oldMarker.remove();
                                        })];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                        ...
                        this.interval = setInterval(function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                            var _this = this;
                            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, this.doHttpRequest().then(function () {
                                            _this.oldLocationMarker.remove();
                                        })];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
    ...
    MapPage.prototype.doHttpRequest = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var oldPosition;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        oldPosition = this.curPos;
                        return [4 /*yield*/, this.deviceService.getCurrentPosition(this.api + "/device")
                                .subscribe(function (response) {
                                _this.curPos = response;
                                if (_this.checkPositionChanged(_this.curPos, oldPosition)) { //theres a new marker
                                    var position = {
                                        lat: _this.curPos.latitude,
                                        lng: _this.curPos.longitude
                                    };
                                    console.log({ latLng: position });
                                    if (_this.curMarker) {
                                        _this.oldMarker = _this.curMarker;
                                        _this.curMarker.remove();
                                    }
                                    return _this.addNewMarker({ latLng: position }, 'blue', 'device location', _this.curMarker)
                                        .then(function (marker) {
                                        _this.curMarker = marker;
                                        // show the infoWindow
                                        marker.showInfoWindow();
                                        // If clicked it, display the alert
                                        marker.on(_ionic_native_google_maps_ngx__WEBPACK_IMPORTED_MODULE_4__["GoogleMapsEvent"].MARKER_CLICK).subscribe(function () {
                                            _this.presentToast('clicked!');
                                        });
                                    });
                                }
    ...
    MapPage.prototype.checkPositionChanged = function (ob1, ob2) {
        if (!ob1.latitude)
            return false;
        if (!ob1.longitude)
            return false;
        if (ob1.latitude !== ob2.latitude || ob1.longitude !== ob2.longitude)
            return true;
        return false;
    };
    MapPage.prototype.getCurrentLocation = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        oldLocation = this.curLocation;
                        return [4 /*yield*/, this.map.getMyLocation()
                                .then(function (location) {
                                // console.log(JSON.stringify(location, null ,2));
                                _this.curLocation = location.latLng;
                                var result = null;
                                if (_this.checkPositionChanged({ "latitude": _this.curLocation.lat, "longitude": _this.curLocation.lng }, { "latitude": oldLocation.lat, "longitude": oldLocation.lng })) {
                                    if (_this.curLocationMarker) {
                                        _this.oldLocationMarker = _this.curLocationMarker;
                                        _this.curLocationMarker.remove();
                                    }
                                    result = _this.addNewMarker({ latLng: _this.curLocation }, 'red', 'current location', _this.curLocationMarker)
                                        .then(function (marker) {
                                        _this.curLocationMarker = marker;
                                        // show the infoWindow
                                        marker.showInfoWindow();
                                        // If clicked it, display the alert
                                        marker.on(_ionic_native_google_maps_ngx__WEBPACK_IMPORTED_MODULE_4__["GoogleMapsEvent"].MARKER_CLICK).subscribe(function () {
    ...
    MapPage.prototype.addNewMarker = function (location, color, _title, _marker) {
        var _this = this;
        return this.map.animateCamera({
            ...
            // add a marker
            _marker = _this.map.addMarker({
                title: _title,
                position: location.latLng,
                animation: _ionic_native_google_maps_ngx__WEBPACK_IMPORTED_MODULE_4__["GoogleMapsAnimation"].BOUNCE,
                icon: color
            });
            return _marker;
        });
    ...
    MapPage.prototype.loadMap = function () {
        ...
        this.map = _ionic_native_google_maps_ngx__WEBPACK_IMPORTED_MODULE_4__["GoogleMaps"].create('map_canvas');
        this.map.one(_ionic_native_google_maps_ngx__WEBPACK_IMPORTED_MODULE_4__["GoogleMapsEvent"].MAP_READY).then(function () {
            _this.mapReady = true;
        });
    };
    MapPage.prototype.presentToast = function (inMessage) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    MapPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"],
            ...
            src_services_device_service__WEBPACK_IMPORTED_MODULE_5__["DeviceService"],
...
var ENV = {
    ...
    endPoint: 'http://192.168.0.33:10010'
};
...
var DeviceService = /** @class */ (function () {
    ...
    DeviceService.prototype.getCurrentPosition = function (baseUrl) {
